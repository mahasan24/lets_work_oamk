...
import { InputGroup, InputGroupAddon } from "@lets_work/ui/components/input-group";
  ...
  return _jsx("div", {
    ...
    children: _jsxs(InputGroup, {
      ...
      children: [
        ...
        _jsx(InputGroupAddon, {
          children: _jsx(SearchIcon, { className: "size-4 shrink-0 opacity-50" }),
        }),
      ],
    }),
  });
