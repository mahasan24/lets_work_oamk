...
const DashboardHirerInvoicesIndexRoute =
  DashboardHirerInvoicesIndexRouteImport.update({
    id: '/invoices/',
    path: '/invoices/',
    getParentRoute: () => DashboardHirerRouteRoute,
  } as any)
...
const DashboardFreelancerInvoicesIndexRoute =
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/dashboard/hirer/invoices/': {
      id: '/dashboard/hirer/invoices/'
      path: '/invoices'
      fullPath: '/dashboard/hirer/invoices/'
    ...
    '/dashboard/freelancer/invoices/': {
      id: '/dashboard/freelancer/invoices/'
      path: '/invoices'
